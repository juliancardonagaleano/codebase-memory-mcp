...
- Grammars: **160** — vendored-from-upstream: **143**, first-party/self-maintained: **12**, registry-disagreement: **5** (nim removed 2026-06-12; objectscript_udl + objectscript_routine added 2026-06-24; mojo added 2026-07-01; mql5 added 2026-07-12 — see notes below)
...
- **mql5** (added 2026-07-12): vendored from [MichalBPL/tree-sitter-mql5](https://github.com/MichalBPL/tree-sitter-mql5) @ `2369df7e68f6a296c16839e65eb4b33cbe7b7c50` — MIT, ABI 15. MQL5 is a C++-derived trading language (Expert Advisors, indicators, scripts for MetaTrader 5) with extensions like `OnInit`/`OnTick` event handlers, color literals, and `#include` of `.mqh` headers. This grammar is not tracked by nvim-treesitter or Helix registries (very young project, 1 star, niche domain). Vendored bytes are byte-identical to upstream `main`. Security review covered the same scope as mojo above.
...
| mql5 | 15 | MichalBPL/tree-sitter-mql5 | `2369df7e68f6` | VERIFIED-NONE | ✅ |
